...
import com.example.faris.revisi.Helper.DirectionJSONParser;
...
public class DriverTracking extends FragmentActivity implements OnMapReadyCallback,
    ...
    String riderLat = "0.0",riderLng = "0.0";
    double fLat, fLng;
    ...
    private Button btnGmaps, btnCall, btnMsg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGmaps = findViewById(R.id.btnGmaps);
        ...
        btnGmaps.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(android.content.Intent.ACTION_VIEW,
                        Uri.parse("http://maps.google.com/maps?saddr="+fLat+","+fLng+"&daddr="+riderLat+","+riderLng+""));
    ...
    private void sendArrivedNotification(String customerId) {
        ...
        //we will notification with title arrived
